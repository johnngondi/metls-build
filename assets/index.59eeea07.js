...
import { u as useUserSession, e as useApi, k as _sfc_main$4, d as _sfc_main$5, _ as _export_sfc } from "./index.4ea6d167.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-a3e3e11c"), n = n(), popScopeId(), n);
...
const _hoisted_26 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", null, "No Pending Payments", -1));
const _hoisted_27 = [
  _hoisted_26
];
const _hoisted_28 = { class: "column is-4" };
const _hoisted_29 = { class: "dashboard-card" };
const _hoisted_30 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "card-head" }, [
  /* @__PURE__ */ createBaseVNode("h3", { class: "dark-inverted" }, "Services"),
  /* @__PURE__ */ createBaseVNode("a", { class: "action-link" }, "View All")
], -1));
const _hoisted_31 = { class: "active-team" };
const _hoisted_32 = { class: "user-list" };
const _hoisted_33 = { class: "user-list-info" };
const _hoisted_34 = { class: "name dark-inverted" };
const _hoisted_35 = { class: "position" };
const _hoisted_36 = { class: "user-list-icons" };
        ...
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_20, [
              ...
              unpaidInvoices.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_22, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unpaidInvoices.value, (item, index2) => {
                  ...
                  return openBlock(), createBlock(_component_VBlock, {
                    ...
                    action: withCtx(() => [
                      createBaseVNode("div", _hoisted_23, toDisplayString(_ctx.$filters.currencyMK(item.total - item.paid)), 1),
                      createBaseVNode("a", {
              ...
              unpaidInvoices.value.length < 1 ? (openBlock(), createElementBlock("div", _hoisted_25, _hoisted_27)) : createCommentVNode("", true)
            ])
          ]),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(myFlows), (flow, index2) => {
                    return openBlock(), createElementBlock("li", { key: index2 }, [
                      createBaseVNode("div", _hoisted_33, [
                        createBaseVNode("div", _hoisted_34, toDisplayString(flow.workflow.name), 1),
                        createBaseVNode("div", _hoisted_35, toDisplayString(flow.workflow.description), 1)
                      ]),
...
var __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a3e3e11c"]]);
const _sfc_main = {};
