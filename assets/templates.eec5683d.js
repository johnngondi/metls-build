...
const _sfc_main = {
  ...
  setup() {
    ...
    const { t } = useI18n();
    pageTitle.value = t("template.title", 2);
    useHead({
      title: `${appName} - ${t("template.title", 2)}`
    });
    return { route };
  }
};
...
var templates = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
