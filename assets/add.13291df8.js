...
import { _ as __unplugin_components_1 } from "./ValidationErrors.b7cefed0.js";
import { _ as __unplugin_components_2 } from "./VControl.a1e5c3aa.js";
import { _ as _sfc_main$3 } from "./VField.897209dd.js";
import { ao as commonjsGlobal, d as defineComponent, l as useWindowScroll, a as useRouter, r as ref, h as computed, a7 as watch, m as resolveComponent, o as openBlock, b as createElementBlock, f as createBaseVNode, n as normalizeClass, s as createVNode, t as withCtx, z as createTextVNode, x as createBlock, y as createCommentVNode, ah as withDirectives, am as vModelText, K as Fragment, J as renderList, v as unref, A as toDisplayString, q as withModifiers } from "./vendor.11f8b2c5.js";
...
var CreateUser_vue_vue_type_style_index_0_lang = "";
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", { class: "left" }, [
  /* @__PURE__ */ createBaseVNode("h3", null, "Create User")
], -1);
...
const _hoisted_8 = /* @__PURE__ */ createBaseVNode("div", { class: "fieldset-heading" }, [
  ...
  /* @__PURE__ */ createBaseVNode("p", null, "This helps us to know you")
], -1);
...
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("label", null, "First Name", -1);
const _hoisted_14 = { class: "column is-6" };
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("label", null, "Last Name", -1);
const _hoisted_16 = { class: "column is-12" };
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("label", null, "Email Address", -1);
const _hoisted_18 = { class: "column is-12" };
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("label", null, "ID Number", -1);
const _hoisted_20 = { class: "column is-12" };
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("label", null, "Phone Number", -1);
const _hoisted_22 = { class: "form-fieldset" };
const _hoisted_23 = /* @__PURE__ */ createBaseVNode("div", { class: "fieldset-heading" }, [
  /* @__PURE__ */ createBaseVNode("h4", null, "Roles and Permissions"),
  /* @__PURE__ */ createBaseVNode("p", null, "Grant user privileges")
], -1);
const _hoisted_24 = { class: "columns is-multiline" };
const _hoisted_25 = { class: "column is-12" };
const _hoisted_26 = /* @__PURE__ */ createBaseVNode("label", null, "User Group", -1);
const _hoisted_27 = { class: "column is-12" };
const _hoisted_28 = /* @__PURE__ */ createBaseVNode("label", null, "Roles", -1);
const _hoisted_29 = { key: 1 };
const _hoisted_30 = { class: "column is-12" };
const _hoisted_31 = /* @__PURE__ */ createBaseVNode("label", null, "Jurisdictions", -1);
...
const _sfc_main$1 = defineComponent({
  ...
  setup(__props) {
    ...
    const { userGroups, roles, fetchRoles, createUser } = useAuth();
    ...
    const registerUser = async () => {
      ...
      loadingText.value = "Creating User ...";
      try {
        const { data } = await createUser(__spreadValues({}, user.value));
    ...
    watch(() => _.cloneDeep(user.value), (current, previous) => {
      if (current.user_group_id != previous.user_group_id && current.user_group_id !== "") {
        const user_group = userGroups.value.filter((item) => item.id === current.user_group_id)[0];
        roles.value = [];
        jurisdictions.value = [];
        user.value.roles = [];
        user.value.jurisdiction_id = void 0;
        if (user_group.has_roles) {
          fetchRoles(current.user_group_id);
        }
        if (user_group.is_jurisdiction_type) {
          fetchJurisdictions(user_group.id);
        }
      }
    });
    return (_ctx, _cache) => {
              ...
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("div", _hoisted_5, [
                  ...
                  createVNode(_component_VButton, {
                    color: "primary",
                    raised: "",
                    onClick: _cache[0] || (_cache[0] = ($event) => registerUser())
                  }, {
                    default: withCtx(() => [
                      ...
                      createVNode(_component_VControl, { icon: "feather:user" }, {
                        default: withCtx(() => [
                          withDirectives(createBaseVNode("input", {
                            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => user.value.first_name = $event),
                            type: "text",
                            class: "input",
                            placeholder: "",
                            autocomplete: "given-name"
                          }, null, 512), [
                            [vModelText, user.value.first_name]
                          ])
                        ]),
                        _: 1
                      })
                      ...
                      createVNode(_component_VControl, { icon: "feather:user" }, {
                        default: withCtx(() => [
                          withDirectives(createBaseVNode("input", {
                            ...
                            [vModelText, user.value.last_name]
                          ])
                        ]),
                        _: 1
                      })
                  ...
                  createVNode(_component_VField, null, {
                    default: withCtx(() => [
                      ...
                      createVNode(_component_VControl, { icon: "feather:mail" }, {
                        default: withCtx(() => [
                          withDirectives(createBaseVNode("input", {
                            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => user.value.email = $event),
                            type: "email",
                            class: "input",
                            placeholder: "",
                            autocomplete: "email",
                  ...
                  createVNode(_component_VField, null, {
                    default: withCtx(() => [
                      ...
                      createVNode(_component_VControl, { icon: "feather:user" }, {
                        default: withCtx(() => [
                          withDirectives(createBaseVNode("input", {
                            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => user.value.id_number = $event),
                            type: "text",
                            class: "input",
                            placeholder: ""
                          }, null, 512), [
                            [vModelText, user.value.id_number]
                          ])
                        ]),
                        _: 1
                      })
                      ...
                      createVNode(_component_VControl, null, {
                        default: withCtx(() => [
                          createVNode(_component_el_select, {
                            modelValue: user.value.user_group_id,
                            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => user.value.user_group_id = $event),
                            filterable: "",
                            size: "large"
                          }, {
                            default: withCtx(() => [
                ...
                createBaseVNode("div", _hoisted_27, [
                  createVNode(_component_VField, null, {
                    default: withCtx(() => [
                      ...
                      createVNode(_component_VControl, null, {
                        default: withCtx(() => [
                          unref(roles).length > 0 ? (openBlock(), createBlock(_component_el_checkbox_group, {
                            key: 0,
                            modelValue: user.value.roles,
                            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => user.value.roles = $event)
                          }, {
                            default: withCtx(() => [
                            ...
                            _: 1
                          }, 8, ["modelValue"])) : (openBlock(), createElementBlock("p", _hoisted_29, "No Roles, please select a user group."))
                        ]),
                        _: 1
                      })
                    ]),
                      ...
                      createVNode(_component_VControl, null, {
                        default: withCtx(() => [
                          unref(jurisdictions).length > 0 ? (openBlock(), createBlock(_component_el_select, {
                            key: 0,
                            modelValue: user.value.jurisdiction_id,
                            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => user.value.jurisdiction_id = $event),
                            filterable: "",
                            size: "large"
                          }, {
                            default: withCtx(() => [
                            ...
                            _: 1
                          }, 8, ["modelValue"])) : (openBlock(), createElementBlock("p", _hoisted_32, "No Jurisdictions, please select a user group."))
                        ]),
                        _: 1
                      })
                    ]),
...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_CreateUser = _sfc_main$1;
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_component_CreateUser)
      ]);
    };
  }
});
