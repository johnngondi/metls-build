...
import { F as useRoute, U as useI18n, H as useHead, m as resolveComponent, o as openBlock, x as createBlock, t as withCtx, s as createVNode, W as Transition, a0 as resolveDynamicComponent } from "./vendor.11f8b2c5.js";
...
const _sfc_main = {
  beforeRouteEnter(to) {
    ...
    if (!hasAccess("manage jurisdictions")) {
      notfy.error({
  ...
  setup() {
    ...
    const { t } = useI18n();
    pageTitle.value = t("jurisdiction.title", 2);
    useHead({ title: `${appName} - ${t("jurisdiction.title", 2)}` });
    return { route };
  }
};
...
var jurisdictions = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export { jurisdictions as default };
