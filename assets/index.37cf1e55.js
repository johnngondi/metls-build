...
import { e as useApi, d as _sfc_main$3, h as _sfc_main$4, _ as _export_sfc, a as useAuthorize, k as _sfc_main$7, j as _sfc_main$8, b as useNotyf } from "./index.256f70c3.js";
...
import { u as usePos } from "./usePos.13e0b1dd.js";
import { d as defineComponent, a6 as toRefs, r as ref, h as computed, a7 as watch, m as resolveComponent, o as openBlock, b as createElementBlock, s as createVNode, t as withCtx, f as createBaseVNode, A as toDisplayString, v as unref, z as createTextVNode, x as createBlock, y as createCommentVNode, K as Fragment, J as renderList, a2 as hooks, p as pushScopeId, e as popScopeId, F as useRoute, a as useRouter, U as useI18n, I as onMounted } from "./vendor.11f8b2c5.js";
var Invoice_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-8b3e9e44"), n = n(), popScopeId(), n);
...
const _sfc_main$1 = defineComponent({
  ...
  setup(__props) {
    ...
    const makeMRAPayment = async (invoice2) => {
      if (mode.value == "") {
        alert("select Payment method!");
        return;
      }
      sendingMRA.value = true;
      await api.post(`mra/invoices/${invoice2}/pay`, {
        mode: mode.value
      }).then((data) => {
        console.log(data);
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_1$1, [
              createBaseVNode("div", _hoisted_2$1, [
                          ...
                          createVNode(_component_VButtons, null, {
                            default: withCtx(() => [
                              ...
                              invoice.value.status !== 0 ? (openBlock(), createBlock(_component_VButton, {
                                ...
                                light: "",
                                color: "info",
                                onClick: _cache[1] || (_cache[1] = ($event) => open(unref(RESOURCE_URL) + `receipts/${invoice.value.id}/download`))
                              }, {
                                default: withCtx(() => [
                              ...
                              invoice.value.mra_payments_count == 0 && invoice.value.status == 0 ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
                                ...
                                createVNode(_component_VButton, {
                                  ...
                                  class: "ml-2",
                                  onClick: _cache[3] || (_cache[3] = ($event) => makeMRAPayment(invoice.value.id))
                                }, {
                                  default: withCtx(() => [
                                ...
                                invoice.value.mra_payments[0].status == "pending" ? (openBlock(), createElementBlock("a", {
                                  key: 0,
                                  href: unref(RESOURCE_URL) + `mra/invoices/${invoice.value.mra_payments[0].id}/print`,
                                  target: "_blank"
                                }, " Print MRA Advice: " + toDisplayString(invoice.value.mra_payments[0].prn), 9, _hoisted_8$1)) : createCommentVNode("", true)
                              ])),
                              redirectNotice.value ? (openBlock(), createElementBlock("span", _hoisted_9$1, "You will now be redirected to DPO platform to submit your payment")) : createCommentVNode("", true)
                            ]),
                            _: 1
                          })
                        ])
                ...
                ])) : (openBlock(), createElementBlock("p", _hoisted_10$1, "Invoice Not Available"))
              ])
            ])
          ]),
          _: 1
...
var __unplugin_components_6 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8b3e9e44"]]);
