...
import { e as useApi, b as useNotyf, a as useAuthorize, _ as _export_sfc } from "./index.4ea6d167.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-5791c099"), n = n(), popScopeId(), n);
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    ...
    const { fetchReportJurisdictions, jurisdictions, fetchCashiers, cashiers, fetchPaymentCount, paymentReports, exportPaymentsReport } = useReporting();
    const { hasAccess } = useAuthorize();
    const filters = reactive({
      jurisdiction: "",
      jurisdiction_type: "",
...
var __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5791c099"]]);
